...
export const createMetricDao = async ({ workspace, name, description, unit, creator }: iCreateMetric) => {
    return await prisma.metric.create({
        data: { workspace, name, description, unit, creator }
    })
}

export const getMetricByIdDao = async (id: string) => {
    return await prisma.metric.findUnique({
        where: { id }
    })
}

export const getMetricsByWorkspaceDao = async ({ user, workspace, cursor, limit }: iGetMetric) => {
...
export const updateMetricDao = async ({ metric, name, description, unit }: iUpdateMetric) => {
...
export const deleteMetricDao = async (metric: string) => {
